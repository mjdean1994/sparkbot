...
module.exports = (message) => {
    ...
    message.author.send({ embeds: [new MessageEmbed().setTitle(`Using the ${primaryActual} now, are you? Cool. What's the other weapon you're using?`)] })
    flowData.setFlowState(message.author.id, 'weapon2Edit')
}